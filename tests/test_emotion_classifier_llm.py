...
class TestEmotionLLMPositiveCases:
    ...
    @pytest.mark.parametrize(
        "sentence,expected_label,label_name",
        [
    ...
    def test_non_neutral_fires_when_warranted(
        self, classifier_llm, sentence, expected_label, label_name
    ):
        result = _classify_emotion(classifier_llm, sentence)
