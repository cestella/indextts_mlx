...
class MLXS2MelPipeline:
    ...
    def __init__(self, config_path: Optional[str] = None, checkpoint_path: Optional[str] = None):
        ...
        if checkpoint_path is None:
            checkpoint_path = str(
                Path.home() / 'code/index-tts-m3-port/prototypes/s2mel_mlx/mlx_weights/s2mel_pytorch.npz'
            )
    ...
    def _load_from_pth(self, checkpoint_path: str):
        ...
        hf_config = str(
            Path.home() / '.cache/huggingface/hub/models--IndexTeam--IndexTTS-2/snapshots/740dcaff396282ffb241903d150ac011cd4b1ede/config.yaml'
        )
        ...
        load_regulator_weights(self.regulator, checkpoint_torch['net']['length_regulator'], verbose=False)
