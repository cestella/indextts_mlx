...
def load_w2vbert_model(model, weights_path: str):
    ...
    flat_weights = {k: v for k, v in flat_weights.items()
    ...
    # Feature projection
    model.feature_projection.layer_norm.weight = flat_weights['feature_projection.layer_norm.weight']
    model.feature_projection.layer_norm.bias = flat_weights['feature_projection.layer_norm.bias']
    model.feature_projection.projection.weight = flat_weights['feature_projection.projection.weight']
    ...
    for layer_idx in range(24):
        ...
        # FFN1
        layer.ffn1.intermediate_dense.weight = flat_weights[f'{prefix}.ffn1.intermediate_dense.weight']
        ...
        layer.self_attn.distance_embedding = flat_weights[f'{prefix}.self_attn.distance_embedding.weight']
        ...
        # Conv module
        layer.conv_module.layer_norm.weight = flat_weights[f'{prefix}.conv_module.layer_norm.weight']
        layer.conv_module.layer_norm.bias = flat_weights[f'{prefix}.conv_module.layer_norm.bias']
        layer.conv_module.pointwise_conv1.weight = flat_weights[f'{prefix}.conv_module.pointwise_conv1.weight']
        layer.conv_module.depthwise_conv.weight = flat_weights[f'{prefix}.conv_module.depthwise_conv.weight']
        layer.conv_module.depthwise_layer_norm.weight = flat_weights[f'{prefix}.conv_module.depthwise_layer_norm.weight']
        layer.conv_module.depthwise_layer_norm.bias = flat_weights[f'{prefix}.conv_module.depthwise_layer_norm.bias']
        layer.conv_module.pointwise_conv2.weight = flat_weights[f'{prefix}.conv_module.pointwise_conv2.weight']

        # FFN2
        layer.ffn2.intermediate_dense.weight = flat_weights[f'{prefix}.ffn2.intermediate_dense.weight']
